...
// import { CSSProperties } from "react"; // For skeleton styles
...
// const fetchPhotos = async (token?: string): Promise<PhotoEntryProps[]> => {
//   const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/picture/get-all-pictures`, {
//     headers: {
...
//       queryClient.invalidateQueries({ queryKey: ["photos", token] });
...
//       {/* Add Sonner toast provider at the root */}
//       <style jsx global>{`
//         @keyframes pulse {
//           0% {
//             opacity: 1;
